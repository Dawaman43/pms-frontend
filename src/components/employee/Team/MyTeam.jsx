...
const MyTeam = () => {
  ...
  const fetchTeamMembers = async () => {
    ...
    try {
      ...
      // ✅ Use data.peers instead of data
      const membersArray = Array.isArray(data.peers) ? data.peers : [];
      ...
      console.log("Updated team members state:", mappedMembers);
    } catch (err) {
            ...
            <div className={styles.teamContainer}>
                    ...
                    {teamMembers.length === 0 ? (
                      <tr>
                        <td colSpan="5" className={styles.emptyState}>
                          No team members found. You may not be assigned to a
                          team.
                        </td>
                      </tr>
                    ) : (
              ...
              {selectedMember && (
                <div className={styles.memberDetails}>
                  <h3 className={styles.panelTitle}>{selectedMember.name}</h3>
                  <p>
